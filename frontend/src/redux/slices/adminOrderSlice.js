...
// async function to fetch all admin orders (admin only)
...
// asycn function to update an order delivery status (admin only)
...
// asycn function to delete an order (admin only)
