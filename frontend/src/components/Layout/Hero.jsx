  ...
  return (
    <>
        <section className='relative bg-black'>
          ...
          <div className='  animate__animated animate__fadeInDown animate_slower absolute font-semibold bottom-[22%] right-[10%] sm:right-[11%] md:right-[5%] md:font-extrabold sm:w-[25%] md:w-[45%] lg:w-[50%] rounded-md text-center py-1 lg:py-2 tracking-widest transition-all hover:cursor-pointer duration-300 '>
