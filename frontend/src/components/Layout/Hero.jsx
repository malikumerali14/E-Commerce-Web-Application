  ...
  return (
    <>
        <section className='relative bg-black'>
          ...
          <div className='  animate__animated animate__fadeInDown animate_slower absolute sm:top-28 md:top-40 font-semibold bottom-[37%] right-[15%] sm:right-[13%] md:right-[5%] md:font-extrabold sm:w-[25%] md:w-[45%] lg:w-[50%] rounded-md text-center py-1 lg:py-2 tracking-widest transition-all hover:cursor-pointer duration-300 '>
            <h1 className='text-transparent text-3xl sm:text-4xl md:text-6xl lg:text-7xl [-webkit-text-stroke:0.05px_red]'>When Virtual Try-On Meets Style</h1>
          </div>
